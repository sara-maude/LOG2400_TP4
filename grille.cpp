...
//     char textureAffichage;
//     for (Point point : points) {
//         textureAffichage = point.getTexture() == ' ' ? '.' : point.getTexture();
//         grille[point.getY()][point.getX()] = textureAffichage;
//     }
//     afficherGrille();
// }
...
//     for (Point point : points) {
//         grille[point.getY()][point.getX()] = '0' + point.getId();
//     }
//     afficherGrille();
// }
